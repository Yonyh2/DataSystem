...
DataSystem es una **aplicación de escritorio desarrollada en Java**, creada como **proyecto de aprendizaje** con el objetivo de practicar y consolidar la mayor cantidad posible de características del lenguaje Java y el desarrollo de aplicaciones de escritorio.

El proyecto fue desarrollado en **NetBeans**, utilizando **Java Swing** para la interfaz gráfica e integrando una **base de datos MySQL** para la gestión de la información.
