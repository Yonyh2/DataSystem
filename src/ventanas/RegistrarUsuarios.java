...
public class RegistrarUsuarios extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel_Footer, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 290, -1, 30));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            if (rs.next()) {
                ...
                if (validacion == 0) {
                    try {
                        ...
                        JOptionPane.showMessageDialog(null, "¡¡Error al registrar!!, contacta con el administrador.");
                    }
            ...
            JOptionPane.showMessageDialog(null, "¡¡Error al comparar usuario!!, contacta con el administrador.");
