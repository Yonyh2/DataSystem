...
public class Informacion_Clientes extends javax.swing.JFrame {
    ...
    public Informacion_Clientes() {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(
                    null, "¡¡Error al cargar!!, + contacta con el administrador");
        }
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel_Wallpaper, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 749, 450));
    ...
    private void jButton_ActualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_ActualizarActionPerformed
        ...
        if (validacion == 0) {
            ...
            try {
                ...
                JOptionPane.showMessageDialog(null, "¡¡Error al actualizar cliente!!, contacta con el administrador");
            }
        } else {
    ...
    private void jButton_ImprimirReporteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_ImprimirReporteActionPerformed
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "Error al generar PDF, contacta con el administrador");
